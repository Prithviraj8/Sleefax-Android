...
//        }
    ...
    public void openFile_ImageSelectionMenu(){
        if(selectingFile){
...
//        }
    ...
    protected void alertMessage() {
        ...
        new AlertDialog.Builder(Pop.this)
        .setMessage("You can only select 5 files at a time for an order")
                .setCancelable(true)
